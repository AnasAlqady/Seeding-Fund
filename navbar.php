...
<body>
 ...
 <header class="site-header" style="margin-bottom:8rem"> <nav class="navbar navbar-default">
<div class="top-line">
		<div class="container">
				<div class="row">
		...
		<div class="container">
				<div class="row">
						<div class="col-md-11">
								...
								<ul class="sf-menu">
										<li class="current" style="margin-right:3rem"> <a href=""> <span style="font-size:2rem"> welcome <?php 
                                ...
                                ?></a> </li>
										...
										<li> <a href="">home</a> </li>
										<li style="margin-left:6rem"> <a href="handle/logout.php"> logout <img src="img/logout.svg" width="20"> </a> </li>
								</ul>
								</nav> </div>
				</div>
		</div>
